...
using Camera = Android.Hardware.Camera2;
...
namespace CustomVision
{
    ...
    public class MainActivity : AppCompatActivity, ISurfaceHolderCallback
    {
        ...
        {
            Camera.CameraManager manager = (Camera.CameraManager)GetSystemService(CameraService);
            /*try
            {
                cameraId = manager.GetCameraIdList()[0];
                Camera.CameraCharacteristics characteristics = manager.GetCameraCharacteristics(cameraId);
                Camera.Params.StreamConfigurationMap map = (Camera.Params.StreamConfigurationMap)characteristics.Get(Camera.CameraCharacteristics.ScalerStreamConfigurationMap);
            }*/
        }
